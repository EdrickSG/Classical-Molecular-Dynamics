...
sim = MDSimulation(steps = 1000, dt = 0.004, r_cutoff= 2.5 ,thermostat = False, kT = .1, gamma = .1, linked_cell_method = True) 
sim.position_init(lattice_structure = "BCC", lattice_constant = 2 ,side_copies = 5) # lattice_constant = 1.5(471) for solid
sim.velocity_init(initial_velocities = initial_velocities)
